...
There are three basic type of TLs connection that can be made to a RabbitMQ server:
...
|Republishing publisher
|4.728
|10575

|===

The FuturePublisher creates a Promise for each message published and stores them in a Deque,
