...
public class RabbitMQClientReconnect2Test {
  
  @SuppressWarnings("constantname")
  private static final Logger logger = LoggerFactory.getLogger(RabbitMQClientReconnect2Test.class);
   ...
   *
   */
  private static final String TEST_EXCHANGE = "RabbitMQClientBuiltinReconnect2Exchange";
  private static final String TEST_QUEUE = "RabbitMQClientBuiltinReconnect2Queue";
  ...
  public RabbitMQClientReconnect2Test() throws IOException {
  ...
  private void createAndStartProducer(Vertx vertx) {
    ...
    publisher = new RabbitMQRepublishingPublisherImpl2(vertx, pubChannel, TEST_EXCHANGE, new RabbitMQPublisherOptions());
