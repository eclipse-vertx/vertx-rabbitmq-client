 ...
 * @author jtalbut
 */
public class FuturePublisherWithRetries implements RabbitMQPublisherStresser {

  private static final Logger log = LoggerFactory.getLogger(FuturePublisherWithRetries.class);
